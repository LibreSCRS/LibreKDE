...
# The fetch branch below takes a fixed revision from the LibreAgent row of deps.lock,
...
set(_librekde_deps_lock "${CMAKE_CURRENT_LIST_DIR}/../deps.lock")
set_property(DIRECTORY APPEND PROPERTY CMAKE_CONFIGURE_DEPENDS "${_librekde_deps_lock}")
file(STRINGS "${_librekde_deps_lock}" _librekde_agent_row REGEX "^LibreAgent[ \t]")
list(LENGTH _librekde_agent_row _librekde_agent_rows)
if(NOT _librekde_agent_rows EQUAL 1)
    message(FATAL_ERROR "deps.lock must hold exactly one LibreAgent row")
endif()
string(REGEX REPLACE "[ \t]+" ";" _librekde_agent_row "${_librekde_agent_row}")
list(GET _librekde_agent_row 1 LIBREAGENT_URL)
list(GET _librekde_agent_row 2 LIBREAGENT_PIN)
