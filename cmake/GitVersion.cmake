...
# `${CMAKE_CURRENT_LIST_DIR}/..` is the repository root. PROJECT_SOURCE_DIR is
# not yet set at the time this module is include()d (project() has not been
# called yet -- it needs the version this file derives), so the root is
# resolved from this module's own location rather than from a project var. It
# is set OUTSIDE the GIT_EXECUTABLE branch because the VERSION fallback below
# needs it in exactly the case where git is not what answers.
