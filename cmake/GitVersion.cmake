...
if(GIT_EXECUTABLE)
  ...
  # `${CMAKE_CURRENT_LIST_DIR}/..` is the repository root. PROJECT_SOURCE_DIR
  # is not yet set at the time this module is include()d (project() has not
  # been called yet — it needs the version this file derives), so the root is
  # resolved from this module's own location rather than from a project var.
